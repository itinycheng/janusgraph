 ...
 * @since solr 8.0
 */
public class CompressLBHttp2SolrClient extends LBSolrClient {
  private CompressHttp2SolrClient httpClient;

  public CompressLBHttp2SolrClient(CompressHttp2SolrClient httpClient, String... baseSolrUrls) {
