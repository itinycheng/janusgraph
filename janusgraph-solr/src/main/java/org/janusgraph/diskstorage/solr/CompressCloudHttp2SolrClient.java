...
public class CompressCloudHttp2SolrClient extends BaseCloudSolrClient {

    private final ClusterStateProvider stateProvider;
    private final CompressLBHttp2SolrClient lbClient;
    private final CompressHttp2SolrClient myClient;
     ...
     *
     * @param builder a {@link CompressHttp2SolrClient.Builder} with the options used to create the client.
     */
    protected CompressCloudHttp2SolrClient(Builder builder) {
        super(builder.shardLeadersOnly, builder.parallelUpdates, builder.directUpdatesToLeadersOnly);
        if (builder.httpClient == null) {
            this.clientIsInternal = true;
            if (builder.internalClientBuilder == null) {
                this.myClient = new CompressHttp2SolrClient.Builder().build();
            } else {
        ...
        this.lbClient = new CompressLBHttp2SolrClient(myClient);
    }
    ...
    public CompressLBHttp2SolrClient getLbClient() {
        return lbClient;
    }
    ...
    public CompressHttp2SolrClient getHttpClient() {
        return myClient;
    }
    ...
    /**
     * Constructs {@link CompressCloudHttp2SolrClient} instances from provided configuration.
     */
    public static class Builder {
        protected Collection<String> zkHosts = new ArrayList<>();
        protected List<String> solrUrls = new ArrayList<>();
        protected String zkChroot;
        protected CompressHttp2SolrClient httpClient;
        protected boolean shardLeadersOnly = true;
        protected boolean directUpdatesToLeadersOnly = false;
        protected boolean parallelUpdates = true;
        protected ClusterStateProvider stateProvider;
        protected CompressHttp2SolrClient.Builder internalClientBuilder;

        /**
         * Provide a series of Solr URLs to be used when configuring {@link CompressCloudHttp2SolrClient} instances.
        ...
        /**
         * Provide a series of ZK hosts which will be used when configuring {@link CompressCloudHttp2SolrClient} instances.
         * <p>
        ...
        /**
         * Tells {@link CompressCloudHttp2SolrClient.Builder} that created clients should send direct updates to shard leaders only.
         * <p>
        ...
        /**
         * Tells {@link CompressCloudHttp2SolrClient.Builder} that created clients can send updates to any shard replica (shard leaders and non-leaders).
         * <p>
        ...
        /**
         * Tells {@link CompressCloudHttp2SolrClient.Builder} whether created clients should send shard updates serially or in parallel
         * <p>
         * When an {@link UpdateRequest} affects multiple shards, {@link CompressCloudHttp2SolrClient} splits it up and sends a request
        ...
        public Builder withHttpClient(CompressHttp2SolrClient httpClient) {
         ...
         * @return this
         */
        public Builder withInternalClientBuilder(CompressHttp2SolrClient.Builder internalClientBuilder) {
        ...
        /**
         * Create a {@link CompressCloudHttp2SolrClient} based on the provided configuration.
         */
        public CompressCloudHttp2SolrClient build() {
            ...
            return new CompressCloudHttp2SolrClient(this);
        }
    }
}
