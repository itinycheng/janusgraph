...
public class GraphDatabaseConfiguration {
    ...
    public static final ConfigOption<String> TX_CACHE_TYPE = new ConfigOption<>(CACHE_NS,"tx-cache-type",
        "Type of the transaction-level cache of recently-used vertices, available:" + Arrays.toString(CacheType.values()),
        ConfigOption.Type.MASKABLE, CacheType.GUAVA.name());
    ...
    public static final ConfigOption<String> TX_VERTEX_CACHE_TYPE = new ConfigOption<>(CACHE_NS, "tx-vertex-cache-type",
        "Vertex cache type. Available values DEFAULT, TREEMAP, NOCACHE",
    ...
    private CacheType txVertexCacheType;
    ...
    public CacheType getTxVertexCacheType() {
        return txVertexCacheType;
    }
    ...
    private void preLoadConfiguration() {
        ...
        txVertexCacheType = CacheType.valueOf(configuration.get(TX_CACHE_TYPE));
